...
import com.example.l7_20demo1.databinding.FragmentTitleBinding;
...
public class TitleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        LiveData liveData;
        //liveData = new ViewModelProvider(this, new NewInstanceFactory()).get(LiveData.class);
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                controller.navigate(R.id.action_titleFragment_to_quesFragment);
            }
        });
